...
// VERTEX Vet Core Suite Pages
import VertexDashboard from "./Pages/VertexVet/VertexDashboard";
import VertexPatientsDirectory from "./Pages/VertexVet/VertexPatientsDirectory";
import VertexPatientProfile360 from "./Pages/VertexVet/VertexPatientProfile360";
import VertexAgendaCalendar from "./Pages/VertexVet/VertexAgendaCalendar";
import VertexConsultations from "./Pages/VertexVet/VertexConsultations";
import VertexPharmacy from "./Pages/VertexVet/VertexPharmacy";
import VertexBilling from "./Pages/VertexVet/VertexBilling";
import VertexStore from "./Pages/VertexVet/VertexStore";
import VertexReports from "./Pages/VertexVet/VertexReports";
import VertexStaffDirectory from "./Pages/VertexVet/VertexStaffDirectory";
import VertexSettings from "./Pages/VertexVet/VertexSettings";
import VertexLogin from "./Pages/VertexVet/VertexLogin";
...
const App = () => {
  return (
    ...
    <ShopContextProvider>
      ...
      <Routes>
        {/* VERTEX Vet SaaS Suite Routes as primary experience */}
        <Route path="/" element={<VertexDashboard />} />
        <Route path="/vet" element={<VertexDashboard />} />
        <Route path="/vet/dashboard" element={<VertexDashboard />} />
        <Route path="/vet/pacientes" element={<VertexPatientsDirectory />} />
        <Route path="/vet/pacientes/:id" element={<VertexPatientProfile360 />} />
        <Route path="/vet/agenda" element={<VertexAgendaCalendar />} />
        <Route path="/vet/consultas" element={<VertexConsultations />} />
        <Route path="/vet/farmacia" element={<VertexPharmacy />} />
        <Route path="/vet/facturacion" element={<VertexBilling />} />
        <Route path="/vet/tienda" element={<VertexStore />} />
        <Route path="/vet/reportes" element={<VertexReports />} />
        <Route path="/vet/usuarios" element={<VertexStaffDirectory />} />
        <Route path="/vet/configuracion" element={<VertexSettings />} />
        <Route path="/vet/login" element={<VertexLogin />} />
        <Route path="/login" element={<VertexLogin />} />
        <Route path="/stafflogin" element={<VertexLogin />} />
        <Route path="/profflogin" element={<VertexLogin />} />
