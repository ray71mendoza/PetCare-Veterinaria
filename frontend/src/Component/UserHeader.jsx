        ...
        <div className="hidden lg:flex lg:gap-x-8 items-center">
          {[
            ...
            <Link
              ...
              className="text-sm font-semibold text-gray-900 hover:text-teal-600 transition-all duration-300"
            >
              {item.label}
            </Link>
          ))}
          <Link
            to="/vet/dashboard"
            className="px-3.5 py-1.5 rounded-xl bg-slate-900 text-teal-400 border border-teal-500/40 text-xs font-bold shadow-sm hover:bg-slate-800 transition-all flex items-center gap-1.5"
          >
            <span className="w-2 h-2 rounded-full bg-teal-400 animate-pulse" />
            <span>VERTEX Vet Suite</span>
          </Link>
